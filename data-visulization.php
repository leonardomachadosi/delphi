...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
    ...
    <div class="w3-container" style="margin-top:80px" id="showcase">
        ...
        <br/>
        <br/>
        <h1 class="w3-xxxlarge w3-text-new"><b>Data Visualization</b></h1>
        <hr style="width:50px;border:5px solid darkcyan" class="w3-round">
        <br/>
        <br/>
        <table class="mdl-data-table mdl-js-data-table tb-new">
            <thead>
            <tr>
                <th class="mdl-data-table__cell--non-numeric">Expert</th>
                <th>Initiative</th>
                <th>Data</th>
                <th>City</th>
                <th>Country</th>
